...
setmetatable(CfgEquipAttrTable, {
	__index = function(t, k)
		error("config error :not find key: [" .. tostring(k) .. "] in table: " .. "[CfgEquipAttrTable]")
	end
})
...
for i, data in pairs(CfgEquipAttrTable) do
	setmetatable(data, defaultMetaTable)
end

return CfgEquipAttrTable
