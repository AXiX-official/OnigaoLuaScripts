...
local CfgCardGroupTable = {
	...
	[104] = {
		CardLabel = 1,
		Id = 104,
		ShowPrefab = "Assets/03_Prefabs/UI/_Lottery/LotteryNew_Appointed_3.prefab",
		Name = getI18NValue(180269034),
		CardJackpotID = {
			50300308,
			50300309
		},
	...
	[106] = {
		CardLabel = 1,
		Id = 106,
		ShowPrefab = "Assets/03_Prefabs/UI/_Lottery/LotteryNew_Appointed_5.prefab",
		Name = getI18NValue(180269423),
		CardJackpotID = {
			50300312,
			50300313
		},
