...
local CfgItemTable = {
	...
	[201] = {
		...
		MaxNum = 99999999,
		Reveal = true,
		SmallIcon = "/Item/Icon_Currency_Other_11.png",
		ItemTypes = 1,
	...
	[60137] = {
		...
		ItemSubTypes = 2,
		DepotType = 16,
		Name = getI18NValue(180269460),
		ItemTips = getI18NValue(180269459),
		ActionParams = {
			10001,
			1,
			10002,
