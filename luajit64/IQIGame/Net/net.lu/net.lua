...
function net_fight.fightOver(storyBattleId, type, fightResult, dmgRecords, attacker, defender, fightData, userData)
	local success = LuaCodeInterface.Send(4902, storyBattleId, type, fightResult, dmgRecords, attacker, defender, fightData, userData)
end
